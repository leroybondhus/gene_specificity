...
###
plot(hclust(as.dist(1-dot_sim),method = "average"), hang = -1, main = "dot_sim,ave_clust")
plot(hclust(as.dist(1-dot_sim),method = "complete"), hang = -1, main = "dot_sim,complete_clust")
heatmap(dot_sim)


colnames(dot_sim_raw) <- colnames(gtex[,3:ncol(gtex)])
rownames(dot_sim_raw) <- colnames(gtex[,3:ncol(gtex)])
plot(hclust(as.dist(1-dot_sim_raw),method = "single"), hang = -1, main = "dot_sim_raw,single_clust")
plot(hclust(as.dist(1-dot_sim_raw),method = "average"), hang = -1, main = "dot_sim_raw,ave_clust")
plot(hclust(as.dist(1-dot_sim_raw),method = "complete"), hang = -1, main = "dot_sim_raw,complete_clust")
heatmap(dot_sim_raw)
