...
filename <- paste(figures_dir,"/",date,"_heatmap.png",sep = "")
png(filename = filename, width=8, height=16, units="in", res=300)
heatmaps$delta
dev.off()


filename <- paste(figures_dir,"/",date,"_heatmap_f_w.png",sep = "")
png(filename = filename, width=16, height=16, units="in", res=300)
...
filename <- paste(figures_dir,"/",date,"marker_genes_grad.png",sep = "")
...
dotplot(ego, showCategory=20)#top 20 
#dev.off()
