...
author: "Leroy Bondhus, Roshni Varma, Yenifer Hernandez"
date: "8/19/2021"
...
```{r Supplemental Figure Go terms associated with diff in 1 v all brain samples, fig.width = 10, fig.height=4}
...
```{r measure sample similarity, fig.width = 6, fig.height=6}
...
```{r Figure_2C, fig.width = 8, fig.height= 8}
...
```{r Figure_2D flat v weighted jaccard plot, fig.width = 6, fig.height= 6}
...
```{r  Figure 3AB flat v weighted comparisons, fig.width = 9,  fig.height=8}
if(TRUE){
...
```{r  Figure 3C marker, fig.width = 9,  fig.height=8}
...
```{r Figure 3D, fig.show="hold", out.width="50%",  fig.height=4}
...
```{r supplemental comparison of clustering methods, fig.width = 9,  fig.height=6}
...
```{r supplemental comparison of similarity measures, fig.width =8,  fig.height=8}
