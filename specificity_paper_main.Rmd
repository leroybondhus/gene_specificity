...
for(i in 1:length(specificity_measures$func_names)){
  el_names <- paste( c("P2_baseline_", "P1_", "P2_")
                     , specificity_measures$func_names[i], sep="")
  temp_list <- setNames(list(list(), list(), list()), nm=el_names  )
...
for(measure in specificity_measures$func_names){
  ...
  P2_flat_baseline <- notP1; P2_flat_baseline[] <-0
  P2_weighted_baseline <- notP1; P2_weighted_baseline[] <-0
  ...
  ## save baseline
  robustness_test_results[[paste("P2_baseline_", measure,sep = "")]] <- list(P2_weighted_baseline=P2_weighted_baseline, P2_flat_baseline=P2_flat_baseline) 
    ...
    robustness_test_results[[paste("P1_", measure,sep = "")]] <- results_P1
    robustness_test_results[[paste("P2_", measure,sep = "")]] <- results_P2
}


for(i in 1:length(robustness_test_results$P1_Zscore)){
  plot(robustness_test_results$P1_Zscore[[1]]$P1_flat_spec_score[,"Spleen"], robustness_test_results$P1_Zscore[[1]]$P1_flat_spec_score[,"Spleen"]-robustness_test_results$P1_Zscore[[i]]$P1_flat_spec_score[,"Spleen"], main = paste("P1 flat:n =",i))
}

for(i in 1:length(robustness_test_results$P1_Zscore)){
  plot(robustness_test_results$P1_Zscore[[1]]$P1_weighted_spec_score[,"Spleen"], robustness_test_results$P1_Zscore[[1]]$P1_weighted_spec_score[,"Spleen"]-robustness_test_results$P1_Zscore[[i]]$P1_weighted_spec_score[,"Spleen"], main = paste("P1 weighted:n =",i))
}

for(i in 1:length(robustness_test_results$P1_Zscore)){
  plot(robustness_test_results$P2_Zscore[[1]]$P2_flat_spec_score[,1], robustness_test_results$P2_Zscore[[1]]$P2_flat_spec_score[,1]- robustness_test_results$P2_Zscore[[i]]$P2_flat_spec_score[,1], main = paste("P2 flat:n =",i))
  }

for(i in 1:length(robustness_test_results$P1_Zscore)){
  plot(robustness_test_results$P2_Zscore[[1]]$P2_weighted_spec_score[,1], robustness_test_results$P2_Zscore[[1]]$P2_weighted_spec_score[,1]- robustness_test_results$P2_Zscore[[i]]$P2_weighted_spec_score[,1], main = paste("P2 weighted:n =",i))
}
