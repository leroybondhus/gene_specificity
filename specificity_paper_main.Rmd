...
g <- arrangeGrob(grobs=grobl,ncol=2)
...
ggsave(filename, g, device = "png", width = 9, height = 8)
...
grid.arrange(grobs=grobl, ncol=2  )
g <- arrangeGrob(grobs=grobl,ncol=2)
filename <- paste(figures_dir,"/",date,"_jaccard_non-random.png",sep = "")
ggsave(filename, g, device = "png", width = 12, height = 8)
...
grid.arrange(grobs=grobl, ncol=2  )
g <- arrangeGrob(grobs=grobl,ncol=2)
filename <- paste(figures_dir,"/",date,"_jaccard_gene_count_non-random.png",sep = "")
ggsave(filename, g, device = "png", width = 12, height = 8)
