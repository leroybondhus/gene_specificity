...
#  dev.off()
  ...
  which_deep <- which(sample_groups_lengths >= 5)
  ...
  for(i in 1:num_reps){
    ...
    temp_sample_groups <- sample_groups[c(which_deep, sample(which_shallow, 2*length(which_deep) ) ) ]
...
cor(as.vector(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_FALSE__balanced_FALSE__rep_2[,colnames(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2)]), use="pairwise.complete")
cor(as.vector(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_TRUE__balanced_FALSE__rep_2[,colnames(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2)]), use="pairwise.complete")

plot(as.vector(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_FALSE__balanced_FALSE__rep_2[,colnames(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2)]));abline(0,1,col="red")
plot(as.vector(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_TRUE__balanced_FALSE__rep_2[,colnames(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2)]));abline(0,1,col="red")


cor(as.vector(results$Tau__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_FALSE__balanced_FALSE__rep_2), use="pairwise.complete")
cor(as.vector(results$Tau__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_TRUE__balanced_FALSE__rep_2), use="pairwise.complete")


plot(as.vector(results$Tau__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_FALSE__balanced_FALSE__rep_2));abline(0,1,col="red")
plot(as.vector(results$Tau__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_TRUE__balanced_FALSE__rep_2));abline(0,1,col="red")
