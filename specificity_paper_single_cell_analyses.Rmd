...
for(i in 1:length(exp_mat_list) ){
  ...
  # filename = paste(figures_dir, "/", names(exp_mat_list)[i], "sample_similarity_heatmap.png", sep="")
...
#  filename = paste(figures_dir, "/", names(exp_mat_list)[i], "weighted_tree.png", sep="")
...
#  dev.off()
  ...
  for(i in 1:num_reps){
    temp_sample_set <- c()
    for(j in 1:length(sample_groups)){
      temp_sample_set <- c(temp_sample_set, sample(sample_groups[[j]],1) )
    }
...
cor(as.vector(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_FALSE__balanced_FALSE__rep_1[,colnames(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2)]), use="pairwise.complete")
cor(as.vector(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_TRUE__balanced_FALSE__rep_1[,colnames(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2)]), use="pairwise.complete")

plot(as.vector(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_FALSE__balanced_FALSE__rep_1[,colnames(results$Zscore__weighted_FALSE__balanced_TRUE__rep_2)]));abline(0,1,col="red")
plot(as.vector(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Zscore__weighted_TRUE__balanced_FALSE__rep_1[,colnames(results$Zscore__weighted_TRUE__balanced_TRUE__rep_2)]));abline(0,1,col="red")


cor(as.vector(results$Tau__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_FALSE__balanced_FALSE__rep_1), use="pairwise.complete")
cor(as.vector(results$Tau__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_TRUE__balanced_FALSE__rep_1), use="pairwise.complete")


plot(as.vector(results$Tau__weighted_FALSE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_FALSE__balanced_FALSE__rep_1));abline(0,1,col="red")
plot(as.vector(results$Tau__weighted_TRUE__balanced_TRUE__rep_2),as.vector(results$Tau__weighted_TRUE__balanced_FALSE__rep_1));abline(0,1,col="red")
