...
for(results_list_id in 1:length(results_list)){
  if(names(results_list)[results_list_id]=="mmusculus"){
    ...
    ## Kidney: Eya1, Six1, Six4, Eya4
    ## Kidney: Hoxd10, Slc12a1, Adamts16,Pappa2, Nphs2, Hoxa10, Tmem72, Sim1, Lama1, Hoxb9 
    ## Myeloid: Cebpe, Csf1r, Cebpa,Pu.1, Elane, Prtn3, Mpo, Apoe, Gata2, Gata1, Gfi1b, Car1, Car2, Klf1,  ,"Lilra5","Ifi30","Pram1","Elane"
